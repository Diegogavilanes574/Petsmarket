    ...
    <div class="page-title">
        ...
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Módulo para poder ingresar, actualizar y eliminar los dueños de las mascotas.</p>
            </div>
                ...
                <table class='table table-striped table-bordered' id="table1">
                    <thead>
                        <tr >
                            ...
                            <th style="background-color: #1d9aac;" class="text-white">No. Mascotas</th>
...
<!--                            <td> <span class="badge bg-success">Active</span> </td>-->
                            <td>
                                <button type="button" class="btn btn-primary" onclick="abrir_modal('<?php echo $fila['id_cliente']; ?>','<?php echo $fila['nombre']; ?>','<?php echo $fila['apellido']; ?>','<?php echo $fila['cedula']; ?>','<?php echo $fila['direccion']; ?>','<?php echo $fila['telf']; ?>','<?php echo $fila['correo']; ?>', '<?php echo $fila['edad']; ?>', '<?php echo $fila['sexo']; ?>', '<?php echo $fila['nacionalidad']; ?>', '<?php echo $fila['clave']; ?>')">Editar</button>

                                <?php
                                if($cantMasc<1) { ?>
                                    <button type="button" class="btn btn-danger" onclick="eliminar('<?php echo $fila['id_cliente']; ?>')">Eliminar</button>
                                <?php } ?>
                            </td>
                        </tr>
                <?php } ?>
...
<!--<script src="assets/vendors/simple-datatables/simple-datatables.js"></script>-->
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title white" id="myModalLabel130">Ingresar Nuevo Cliente</h5>
                ...
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="post" action="php/cli_grabar.php" id="formulario">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-6">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title white" id="myModalLabel160">Editar Cliente</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i data-feather="x"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="post" action="php/cli_editar.php" id="formulario2">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-6">
    ...
    if (isset($_GET['mn'])){
        $num = $_GET['mn'];
        if($num==1 || $num=="1"){
            echo '<script>swal("Cliente eliminado con éxito");</script>';
        }else if($num == 3 || $num=="3"){
            echo '<script>swal("Cliente ingresado con éxito");</script>';
        }else if($num == 4 || $num=="4"){
            echo '<script>swal("Cliente actualizado con éxito");</script>';
        }else{
    ...
    <script>
        var h = 1;
        var h1 = 1;
        function abrir_modal(ide, no, ap, ce, di, te, co, ed, se,na, cl){
        ...
        function  eliminar(idx){
            swal({
                ...
                function() {
                    window.location.href ="php/cli_eliminar.php?valor="+idx;
                });
        }
        ...
        function validarCedenBD() {
            var cedw = $("#ced").val();
            $.ajax({
                url: 'validacion/cedulaBD3.php?ced=' + cedw,
                type: 'get',
                success: function(response) {
                    console.log(response);
                    if (response == "si") {
        ...
        function validarCedenBD2() {
            ...
            var idem = $("#id_cli").val();
            $.ajax({
                url: 'validacion/cedulaBD4.php?ced=' + cedw + '&idreg=' + idem,
                type: 'get',
                success: function(response) {
                    console.log(response);
                    if (response == "si") {
