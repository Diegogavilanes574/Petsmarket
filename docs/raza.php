    ...
    <div class="page-title">
        ...
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Módulo para poder ingresar, actualizar y eliminar razas de las especies.</p>
            </div>
                ...
                <table class='table table-striped table-bordered' id="table1">
                    <thead>
                        <tr >
                            ...
                            <th style="background-color: #1d9aac;" class="text-white">Especie</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary" onclick="abrir_modal('<?php echo $fila['id_raza']; ?>',  '<?php echo $fila['nombre']; ?>', '<?php echo $fila['id_especie']; ?>')">Editar</button>
                                <button type="button" class="btn btn-danger" onclick="eliminar('<?php echo $fila['id_raza']; ?>')">Eliminar</button>
...
<!--<script src="assets/vendors/simple-datatables/simple-datatables.js"></script>-->
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title white" id="myModalLabel130">Ingresar Nueva Raza</h5>
                ...
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="post" action="php/raz_grabar.php" id="formulario">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nom" class="form-control" onchange="validarRazenBD();" name="nom"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="esp" name="esp" class="form-select">
                                                        ...
                                                        while($fila = $resultado->fetch_array()){
                                                            ...
                                                            <option value="<?php echo $fila['id_especie']; ?>"><?php echo $fila['nombre']; ?></option>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title white" id="myModalLabel160">Editar Raza</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i data-feather="x"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" method="post" action="php/raz_editar.php" id="formulario2">
                                    <div class="form-body">
                                        <div class="row">

                                                <input type="hidden" id="id_raz" name="id_raz">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="nom">Nombre</label>
                                                    <input type="text" id="nom0" class="form-control" onchange="validarRazenBD2();" name="nom"
                                                           placeholder="Escriba el nombre" required>
                                                </div>
                                            </div>
    ...
    if (isset($_GET['mn'])){
        $num = $_GET['mn'];
        if($num==1 || $num=="1"){
            echo '<script>swal("Raza eliminada con éxito");</script>';
        }else if($num == 3 || $num=="3"){
            echo '<script>swal("Raza ingresada con éxito");</script>';
        }else if($num == 4 || $num=="4"){
            echo '<script>swal("Raza actualizada con éxito");</script>';
        }else{
    ...
    <script>
        var h = 1;
        var h1 = 1;
        function abrir_modal(ide, no, es){
            $("#id_esp").val(ide);
            $("#esp0").val(es);
            $("#nom0").val(no);
            $("#primary").modal("show");
        ...
        function  eliminar(idx){
            swal({
                ...
                function() {
                    window.location.href ="php/raz_eliminar.php?valor="+idx;
                });
        }
        ...
        function validarRazenBD() {
            var nom = $("#nom").val();
            $.ajax({
                url: 'validacion/nombreBD.php?nom=' + nom + "&tipo=raz",
                type: 'get',
                success: function(response) {
                    console.log(response);
                    if (response == "si") {
                        swal("La raza ya existe por favor, registrar con otro nombre");
                        $("#nom").val("");
                    }
                }
            });
        ...
        function validarRazenBD2() {
            ...
            var idem = $("#id_suc").val();
            $.ajax({
                url: 'validacion/nombreBD2.php?nom=' + nom + '&idreg=' + idem + "&tipo=raz",
                type: 'get',
                success: function(response) {
                    console.log(response);
                    if (response == "si") {
